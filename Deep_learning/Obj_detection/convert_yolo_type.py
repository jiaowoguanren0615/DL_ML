...
# label标签对应json文件
label_json_path = './my_detection_classes.json'
...
# 检查文件/文件夹都是否存在
assert os.path.exists(voc_images_path), "images path not exist..."
assert os.path.exists(voc_xml_path), "xml path not exist..."
