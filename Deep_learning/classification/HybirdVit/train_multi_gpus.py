...
from HybridVitModel import NeuralNetwork as make_model
from ..ViT.split_data import read_split_data
import sys
import pandas as pd


def train(net, batch_size, num_gpus, lr, weight_decay, epochs, save_path, best_val_acc):
...
if __name__ == '__main__':
    ...
    print(f'Loading Best Val Accuracy is {best_val_acc}')
    train(net=net, batch_size=batch_size, num_gpus=num_gpus,
          lr=lr, weight_decay=weight_decay, epochs=epochs, save_path=save_path, best_val_acc=best_val_acc)