    ...
    def __init__(self, in_chans, embed_dim, resolution):
        super(PatchEmbedding, self).__init__(
            ...
            Conv2d_BN(embed_dim[0] // 8, embed_dim[0] // 4, 3, 2, 1,
                      resolution=resolution // 2), torch.nn.ReLU(inplace=True),
            Conv2d_BN(embed_dim[0] // 4, embed_dim[0] // 2, 3, 2, 1,
                      resolution=resolution // 4), torch.nn.ReLU(inplace=True),
...
class EfficientViT(nn.Module):
    def __init__(self, img_size=224,
        ...
        #                                        Conv2d_BN(embed_dim[0] // 2, embed_dim[0], 3, 2, 1,
        #                                                  resolution=resolution // 8))
        self.patch_embed = PatchEmbedding(in_chans, embed_dim, resolution)
