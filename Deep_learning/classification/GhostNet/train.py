...
from ghostnet_model import ghostnet
import sys
...
def main(args):
    ...
    if os.path.exists("./GhostNet") is False:
        os.makedirs("./GhostNet")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(save_file, "./GhostNet/model.pth")
    ...
    Plot_ROC(model, val_loader, "./GhostNet/model.pth", device)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--num_classes', type=int, default=5) # number classes
    parser.add_argument('--epochs', type=int, default=2) # train epochs
