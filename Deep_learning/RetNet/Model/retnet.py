...
from utils import ComplexFFN, ComplexGroupNorm, ComplexLayerNorm, split_heads, split_chunks
...
class MultiScaleRetention(nn.Module):
    ...
    def __init__(self, config: RetNetConfig):
        ...
        self.gn = ComplexGroupNorm(num_groups=config.num_heads, num_channels=config.v_dim)
    ...
    def forward(self, x, past_kv=None, forward_impl='parallel', sequence_offset=0):
        ...
        # out gate & proj
        out = self.swish(self.gated(x)) * normed
