...
def main(args):
    ...
    nw = min([os.cpu_count(), batch_size if batch_size > 1 else 0, 8]) if 'linux' in system_name else 0  # number of workers
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="D:/flower_data")
